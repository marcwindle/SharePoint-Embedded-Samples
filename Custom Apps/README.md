...
Runnable sample applications demonstrating SharePoint Embedded integration patterns. Each folder is an independent project with its own dependencies and setup instructions.
